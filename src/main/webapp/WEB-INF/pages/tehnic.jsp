...
<head>
    ...
    <meta charset="UTF-8">
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/cssfortehnic.css"/>
...
<div class="container">
    ...
    <h1 class="result"></h1>
    <img src="/talasagro.com/selhoztehnicajaxphoto" class="myimage">
    <p class="result2"></p>
...
<script type="text/javascript">
    function a(){
        $.ajax({
            url: '/talasagro.com/selhoztehnicajax',
            dataType:'json',
